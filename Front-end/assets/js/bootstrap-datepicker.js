(function (undefined) {
  ...
  (function (factory) {
    ...
    return moment.defineLocale("bn", {
      months:
        "à¦œà¦¾à¦¨à§à¦¯à¦¼à¦¾à¦°à§€_à¦«à§‡à¦¬à§à¦¯à¦¼à¦¾à¦°à§€_à¦®à¦¾à¦°à§à¦š_à¦à¦ªà§à¦°à¦¿à¦²_à¦®à§‡_à¦œà§à¦¨_à¦œà§à¦²à¦¾à¦‡_à¦…à¦—à¦¾à¦¸à§à¦Ÿ_à¦¸à§‡à¦ªà§à¦Ÿà§‡à¦®à§à¦¬à¦°_à¦…à¦•à§à¦Ÿà§‹à¦¬à¦°_à¦¨à¦­à§‡à¦®à§à¦¬à¦°_à¦¡à¦¿à¦¸à§‡à¦®à§à¦¬à¦°".split(
          "_"
        ),
      monthsShort:
  ...
  (function (factory) {
    ...
    return moment.defineLocale("bs", {
      ...
      weekdays:
        "nedjelja_ponedjeljak_utorak_srijeda_Äetvrtak_petak_subota".split("_"),
  ...
  (function (factory) {
    ...
    var months =
      ...
      monthsShort =
        "led_Ãºno_bÅ™e_dub_kvÄ›_Ävn_Ävc_srp_zÃ¡Å™_Å™Ã­j_lis_pro".split("_");
  ...
  (function (factory) {
    ...
    return moment.defineLocale("eo", {
      ...
      weekdays: "DimanÄ‰o_Lundo_Mardo_Merkredo_Ä´aÅ­do_Vendredo_Sabato".split(
        "_"
      ),
  ...
  (function (factory) {
    ...
    return moment.defineLocale("hu", {
      ...
      weekdays:
        "vasÃ¡rnap_hÃ©tfÅ‘_kedd_szerda_csÃ¼tÃ¶rtÃ¶k_pÃ©ntek_szombat".split("_"),
  ...
  (function (factory) {
    ...
    return moment.defineLocale("ka", {
      ...
      relativeTime: {
        ...
        past: function (s) {
          if (
            /(áƒ¬áƒáƒ›áƒ˜|áƒ¬áƒ£áƒ—áƒ˜|áƒ¡áƒáƒáƒ—áƒ˜|áƒ“áƒ¦áƒ”|áƒ—áƒ•áƒ”)/.test(
              s
            )
          ) {
  ...
  (function (factory) {
    ...
    function relativeWeekDay(moment, format) {
      ...
      return nominative
        ? weekDay
        : weekDay.substring(0, weekDay.length - 2) + "Ä¯";
    }
  ...
  (function (factory) {
    ...
    return moment.defineLocale("ne", {
      ...
      weekdaysMin: "à¤†à¤‡._à¤¸à¥‹._à¤®à¤™à¥_à¤¬à¥._à¤¬à¤¿._à¤¶à¥._à¤¶.".split(
        "_"
      ),
      longDateFormat: {
        LT: "Aà¤•à¥‹ h:mm à¤¬à¤œà¥‡",
  ...
  (function (factory) {
    ...
    function weekdaysCaseReplace(m, format) {
      var weekdays = {
        ...
        nounCase =
          /\[ ?[Ð’Ð²] ?(?:Ð¿Ñ€Ð¾ÑˆÐ»ÑƒÑŽ|ÑÐ»ÐµÐ´ÑƒÑŽÑ‰ÑƒÑŽ|ÑÑ‚Ñƒ)? ?\] ?dddd/.test(
            format
          )
            ? "accusative"
            : "nominative";
  ...
  (function (factory) {
    ...
    var months =
      ...
      monthsShort = "jan_feb_mar_apr_mÃ¡j_jÃºn_jÃºl_aug_sep_okt_nov_dec".split(
        "_"
      );
  ...
  (function (factory) {
    ...
    return moment.defineLocale("ta", {
      months:
        "à®œà®©à®µà®°à®¿_à®ªà®¿à®ªà¯à®°à®µà®°à®¿_à®®à®¾à®°à¯à®šà¯_à®à®ªà¯à®°à®²à¯_à®®à¯‡_à®œà¯‚à®©à¯_à®œà¯‚à®²à¯ˆ_à®†à®•à®¸à¯à®Ÿà¯_à®šà¯†à®ªà¯à®Ÿà¯†à®®à¯à®ªà®°à¯_à®…à®•à¯à®Ÿà¯‹à®ªà®°à¯_à®¨à®µà®®à¯à®ªà®°à¯_à®Ÿà®¿à®šà®®à¯à®ªà®°à¯".split(
          "_"
        ),
      monthsShort:
        "à®œà®©à®µà®°à®¿_à®ªà®¿à®ªà¯à®°à®µà®°à®¿_à®®à®¾à®°à¯à®šà¯_à®à®ªà¯à®°à®²à¯_à®®à¯‡_à®œà¯‚à®©à¯_à®œà¯‚à®²à¯ˆ_à®†à®•à®¸à¯à®Ÿà¯_à®šà¯†à®ªà¯à®Ÿà¯†à®®à¯à®ªà®°à¯_à®…à®•à¯à®Ÿà¯‹à®ªà®°à¯_à®¨à®µà®®à¯à®ªà®°à¯_à®Ÿà®¿à®šà®®à¯à®ªà®°à¯".split(
  ...
  (function (factory) {
    ...
    return moment.defineLocale("tr", {
      ...
      weekdays:
        "Pazar_Pazartesi_SalÄ±_Ã‡arÅŸamba_PerÅŸembe_Cuma_Cumartesi".split("_"),
      ...
      calendar: {
        ...
        lastWeek: function () {
          switch (this.day()) {
            ...
            case 2:
            case 4:
              return processHoursFunction("[ÐœÐ¸Ð½ÑƒÐ»Ð¾Ð³Ð¾] dddd [").call(
                this
              );
          }
        },
