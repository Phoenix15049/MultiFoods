...
jQuery(document).ready(function () {
  ...
  if (jQuery(".main-location > ul > li:first-child").length != "") {
    $(".main-location > ul > li:first-child > ul li").wrapAll(
      "<div class='max-location-height' />"
    );
  }
  $(".main-location > ul > li.location-has-children > a").on(
    "click",
    function (e) {
      e.preventDefault();
      ...
      setTimeout(function () {
        $(".main-location > ul > li.location-has-children > a").addClass(
          "open-overlay"
        );
      }, 2);
      $(this).parent().append("<div class='location-overlay'></div>");
      $(".main-location > ul > li > ul").append(
        "<i class='icon-cross3 close-menu-location'></i>"
      );
    }
  );
  $(document).on(
    "click",
    ".main-location > ul > li.location-has-children > a.open-overlay",
    function () {
      $(".location-overlay").remove();
      $(".close-menu-location").remove();
      setTimeout(function () {
        $(".main-location > ul > li.location-has-children > a").removeClass(
          "open-overlay"
        );
      }, 2);
    }
  ...
  $(document).on("click", ".location-overlay", function () {
    ...
    $(".close-menu-location").remove();
    $(".main-location > ul > li.location-has-children").removeClass(
      "menu-open"
    );
    $(".main-location > ul > li.location-has-children > a").removeClass(
      "open-overlay"
  ...
  function StickyHeader() {
    ...
    if ($("#header.sticky-header").length) {
      ...
      $(window).scroll(function () {
        ...
        if (jQuery(".main-section .page-content-fullwidth").length != "") {
          //for woo cart page
        ...
        if (jQuery(".page-template .wrapper #main .container").length != "") {
          //fro order detail page
          var PageSectionHeight = jQuery(
            ".page-template .wrapper #main .container"
          );
  ...
  jQuery(document).on(
    "click",
    ".reviews-sortby li.reviews-sortby-active",
    function () {
      jQuery(".reviews-sortby > li")
        .siblings()
        .removeClass("reviews-sortby-active");
    }
  );
...
function foodbakery_show_response_theme(loader_data, loading_element) {
  ...
  if (loader_data != "undefined" && loader_data != "") {
    if (loader_data.type != "undefined" && loader_data.type == "error") {
      ...
      loader_data.type != "undefined" &&
      loader_data.type == "success"
    ) {
...
jQuery(document).ready(function ($) {
  if (jQuery(".foodbakery-fancy-menu li.current-menu-parent a").length > 0) {
    ...
    jQuery(".foodbakery-fancy-menu li").first().children("ul.sub-menu").length >
    0
  ) {
    jQuery(".foodbakery-fancy-menu li")
      .first()
