    ...
    init: function () {
      jQuery(document).on("click", ".chosen-container", function () {
        ...
        if (jQuery(".chosen-search").length > 0) {
          var get_chosen_search_height = jQuery(this)
            .find(".chosen-search")
            .innerHeight();
        }
        jQuery("body")
          .find(".chosen-has-backdrop")
          .removeClass("chosen-has-backdrop")
          .css({
            position: "",
            "z-index": "",
          });
...
jQuery(document).ready(function () {
  jQuery(".menu-itam-holder .menu-itam-list .image-holder a").attr(
    "rel",
    "prettyPhoto"
  );
  ...
  jQuery("a.restaurant-team-member-det").click(function () {
    event.preventDefault();
    $(".invite-member.team-member-det-box")
      .delay(200)
      .queue(function (next) {
  ...
  jQuery(document).on("click", ".invite-member a.cancel", function (e) {
    ...
    jQuery("body").removeClass("invite-member-open");
    jQuery(this)
      .parents("invite-member.team-member-det-box")
      .removeClass("active");
  ...
  jQuery(".dashboard-review-reply-btn").click(function () {
    ...
    jQuery(".dashboard-add-new-review-holder.add-new-review-holder").css(
      "display",
      "block"
    );
  });
  ...
  jQuery(document).on(
    ...
    function () {
      ...
      jQuery(".user-dashboard-menu > ul > li").append(
        "<div class='location-overlay'></div>"
      );
      jQuery(".user-dashboard-menu > ul > li > ul").append(
  ...
  jQuery(document).on(
    "click",
    ".user-dashboard-menu > ul > li.user-dashboard-menu-children > a.open-overlay",
    function () {
  ...
  jQuery(document).on("click", ".location-overlay", function () {
    ...
    jQuery(".close-menu-location").remove();
    jQuery(
      ".user-dashboard-menu > ul > li.user-dashboard-menu-children"
  ...
  function stickyElement(element, width, eleOrder, elePos, stopTarget) {
    ...
    this.addWrapper = function () {
      if (!this.element.parent().hasClass("sticky-wrpper")) {
        ...
        this.element
          .parent()
          .css("height", this.element.outerHeight(true) + "px");
      }
    };
  ...
  if ($(".stickynav-tabs").length > 0) {
    ...
    stickyHeader = new stickyElement(
      $(".stickynav-tabs"),
      "initial",
      "first",
      "15"
    );
    stickySearch = new stickyElement(
      $(".sticky-search"),
      "initial",
      "",
      "58",
